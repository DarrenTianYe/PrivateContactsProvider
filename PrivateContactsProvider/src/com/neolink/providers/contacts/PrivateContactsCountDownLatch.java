 ...
 * prior to calling {@code countDown()} <a
 * href="package-summary.html#MemoryVisibility"><i>happen-before</i></a> actions
 * following a successful return from a corresponding {@code await()} in another
 * thread.
 * 
 * @since 1.5
 * @author Doug Lea
 */
public class PrivateContactsCountDownLatch {
	/**
	 ...
	 */
	public PrivateContactsCountDownLatch(int count) {
		if (count < 0)
